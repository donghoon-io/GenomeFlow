...
const Job_selection = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  return `${$$result.head += `${$$result.title = `<title>job_selection</title>`, ""}`, ""}
...
<section><div class="${"bg-gray-50 drop-shadow-lg overflow-hidden sm:rounded-lg mb-3"}"><div class="${"px-4 py-5 sm:px-6"}"><div class="${"flex gap-3"}"><a href="${"/"}"><svg class="${"w-6 h-6 dark:text-black"}" fill="${"none"}" stroke="${"currentColor"}" viewBox="${"0 0 24 24"}" xmlns="${"http://www.w3.org/2000/svg"}"><path stroke-linecap="${"round"}" stroke-linejoin="${"round"}" stroke-width="${"2"}" d="${"M10 19l-7-7m0 0l7-7m-7 7h18"}"></path></svg></a>
	...
	<div class="${"relative overflow-x-auto bg-gray-50 drop-shadow-lg sm:rounded-lg mt-3"}"><table class="${"w-full text-sm text-left text-gray-500"}"><thead class="${"text-xs text-gray-700 uppercase bg-gray-100 border-b"}"><tr><th scope="${"col"}" class="${"px-6 py-3"}">No </th>
					<th scope="${"col"}" class="${"px-6 py-3"}">Project name </th>
					<th scope="${"col"}" class="${"px-6 py-3"}">Job name </th>
					<th scope="${"col"}" class="${"px-6 py-3"}">Job status </th>
					<th scope="${"col"}" class="${"px-6 py-3"}">Total tasks
			...
			<tbody><tr class="${"bg-gray-50 border-b"}"><th scope="${"row"}" class="${"px-6 py-4 font-medium text-gray-900 whitespace-nowrap"}">1 </th>
					<td class="${"px-6 py-4"}">aleelab-ten </td>
					<td class="${"px-6 py-4"}">ESCA </td>
					...
					<td class="${"px-6 py-4"}">16:20 </td>
					<td class="${"px-6 py-4"}">$1.21 </td>
					<td class="${"px-6 py-4"}">12/15/2021 12:26:49 AM </td></tr>
				<tr class="${"bg-gray-50 border-b"}"><th scope="${"row"}" class="${"px-6 py-4 font-medium text-gray-900 whitespace-nowrap"}">1 </th>
					<td class="${"px-6 py-4"}">aleelab-ten </td>
					<td class="${"px-6 py-4"}">ESCA </td>
					<td class="${"px-6 py-4"}"><p class="${"text-sm text-black bg-yellow-300 px-2 py-1 rounded-md text-center"}">Pending</p></td>
					<td class="${"px-6 py-4"}">173 (0 / 141 / 32) </td>
					<td class="${"px-6 py-4"}">16:20 </td>
					<td class="${"px-6 py-4"}">$1.21 </td>
					<td class="${"px-6 py-4"}">12/15/2021 12:26:49 AM </td></tr>
				...
				<tr class="${"bg-gray-50 border-b"}"><th scope="${"row"}" class="${"px-6 py-4 font-medium text-gray-900 whitespace-nowrap"}">1 </th>
					...
					<td class="${"px-6 py-4"}">16:20 </td>
					<td class="${"px-6 py-4"}">$1.21 </td>
					<td class="${"px-6 py-4"}">12/15/2021 12:26:49 AM </td></tr></tbody></table></div></section>`;
});
export { Job_selection as default, prerender };
